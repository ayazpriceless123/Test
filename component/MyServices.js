    ...
    <Container
      ...
      <ScrollView>
        <View
          ...
          <Card style={{width: '40%'}}>
            <TouchableOpacity activeOpacity={1}  onPressIn={() => navigation.navigate('Performance')}>
            <CardItem
              cardBody
          ...
          <TouchableOpacity activeOpacity={1}  onPressIn={() => navigation.navigate('Leave')}>
            <CardItem
              cardBody
              style={{height: 100, flex: 1, justifyContent: 'center'}}>
              <Image
        ...
        <View
          ...
          <Card style={{width: '40%'}}>
          <TouchableOpacity activeOpacity={1}  onPressIn={() => navigation.navigate('Organization')}>
            <CardItem
              cardBody
              style={{height: 100, flex: 1, justifyContent: 'center'}}>
              <Image
          ...
          <Card style={{width: '40%', marginLeft: '3%'}}>
          <TouchableOpacity activeOpacity={1}  onPressIn={() => navigation.navigate('Timesheet')}>
            <CardItem
              cardBody
              style={{height: 100, flex: 1, justifyContent: 'center'}}>
              <Image
        ...
        <View
          ...
          <Card style={{width: '40%'}}>
          <TouchableOpacity activeOpacity={1}  onPressIn={() => navigation.navigate('Attendance')}>
            <CardItem
              cardBody
              style={{height: 100, flex: 1, justifyContent: 'center'}}>
              <Image
          ...
          <Card style={{width: '40%', marginLeft: '3%'}}>
          <TouchableOpacity activeOpacity={1}  onPressIn={() => navigation.navigate('Files')}>
            <CardItem
              cardBody
              style={{height: 100, flex: 1, justifyContent: 'center'}}>
              <Image
